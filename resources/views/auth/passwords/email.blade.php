                    ...
                    <div class="text-center mt-4">
                        <div class="mb-3">
                            <a href="{{ url('/') }}" class="auth-logo">
                                <img src="{{ asset('assets/Logo-Sistemas.png') }}" height="80" class="logo-dark mx-auto" alt="">
                                <img src="{{ asset('assets/Logo-Sistemas.png') }}" height="80" class="logo-light mx-auto" alt="">
                            </a>
                        </div>
                    </div>
